    ...
    >
      <Container maxWidth="lg" style={{ paddingLeft: '10%', paddingRight: '10%' }}>
        ...
        <MotionPaper
          ...
          style={{ padding: '20px', marginBottom: '20px', backgroundColor: 'white', borderRadius: '10px', border: '1px solid #e0e0e0' }}
        >
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Typography variant="body1">Created By: {user ? `${user.FName} ${user.LName}` : 'Loading...'}</Typography>
              <Typography variant="body1">Created At: {dataset ? new Date(dataset.CreatedAt).toLocaleString() : 'Loading...'}</Typography>
              <Typography variant="body1">Download Count: {dataset ? dataset.DownloadCount : 'Loading...'}</Typography>
              <Typography variant="body1">Dataset Tags: {dataset ? dataset.Tags : 'Loading...'}</Typography>
            </MotionPaper>
          </Grid>
        </Grid>
      </Container>
