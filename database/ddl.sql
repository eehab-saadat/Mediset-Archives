...
CREATE TABLE DatasetVotes (
	...
	DatasetID INT FOREIGN KEY REFERENCES Dataset(DatasetID) ON DELETE CASCADE NOT NULL,
	VotedBy INT FOREIGN KEY REFERENCES [User](UserID) ON DELETE CASCADE NOT NULL,
	Vote BIT DEFAULT 0 -- SET TO 0 IF 'DOWNVOTE', 1 IF 'UPVOTE'. 0 BY DEFAULT.
);

CREATE TABLE DatasetComments (
	CommentID INT IDENTITY(1,1) PRIMARY KEY,
	DatasetID INT FOREIGN KEY REFERENCES Dataset(DatasetID) ON DELETE CASCADE NOT NULL,
	CommentedBy INT FOREIGN KEY REFERENCES [User](UserID) ON DELETE CASCADE NOT NULL,
	Comment VARCHAR(100) NOT NULL,
	CommentedAt DATETIME DEFAULT GETDATE() NOT NULL
);